...
import {
  defaultCertificateKeySize, serverCertSourceAutogenerated, VchNetworkView, VchOperationsView, VchSecurityView,
  VchStorageView
} from '../../../interfaces/vch';
...
describe('CLI Component', () => {
  ...
  const operations: VchOperationsView = {
    opsUser: '',
    opsPassword: ''
  };

  const security: VchSecurityView = {
  ...
  const storageCapacity: VchStorageView = {
    baseImageSize: '8',
