...
import {
  defaultCertificateKeySize, serverCertSourceAutogenerated, serverCertSourceExisting, VchNetworkView, VchSecurityTlsCaView,
  VchSecurityView
} from '../../../interfaces/vch';
...
export class VchSecurityComponent extends VchComponentBase implements OnInit {
  ...
  public tlsServerCertContents: VchSecurityTlsCaView = null;
  public tlsServerKeyContents: VchSecurityTlsCaView = null;
  public tlsServerError: string = null;
  // array that keeps track of TLS CA files' name and content
  public tlsCaContents: VchSecurityTlsCaView[] = [];
