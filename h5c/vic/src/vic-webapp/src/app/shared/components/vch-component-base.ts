...
import {VchUiCompute, VchUiGeneral, VchUiModelTypes} from '../../interfaces/vch';
...
export abstract class VchComponentBase implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.formValueChangesSubscription = this.form
      .valueChanges
      .subscribe(value => this.validateAndEmitCurrentModel());
  }

  protected abstract setFormValues(model: VchUiModelTypes);

  protected abstract validateAndEmitCurrentModel();

  abstract onCommit(): Observable<VchUiModelTypes>;
