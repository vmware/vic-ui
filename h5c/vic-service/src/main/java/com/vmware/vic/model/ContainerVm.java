...
public class ContainerVm extends VicBaseVm {
    ...
    private String _vchEndpointVmMorValue = null;
    ...
    /**
     * Getter for VCH endpoint's ManagedObjectReference value
     */
    public String getVchEndpointVmMorValue() {
        return _vchEndpointVmMorValue;
    }
    ...
    /**
     * Set _parentObjectMorId which is the MOR value for the VCH endpoint VM
     * @param name
     */
    public void setVchEndpointVmMorValue(String id) {
        _vchEndpointVmMorValue = id;
    }
}
