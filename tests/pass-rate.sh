...
echo "Current vmware/vic-ui CI passrate: $passrate"
curl --max-time 10 --retry 3 -s -d "payload={'channel': '#vic-bots', 'text': 'Current vmware/vic-ui CI passrate: $passrate%'}" "$SLACK_URL"
